---
name: caijing-risk
description: 财经·排雷——只回答"有没有雷"。学术模型打底（Beneish M-Score 盈余操纵、Altman Z 财务困境）+ A股本土红旗库（大存大贷/非标审计/其他应收款/在建工程/质押减持等）+ 港股专属（老千股模式/CCASS集中度）+ 跨市场恶化因子扫描（收入放缓、毛利率压缩、应收存货快于收入、内部人减持等）。专业版保留红黄绿总评与一票否决项，客户版降级为公开信息提示项。默认产出专业版排雷报告 docx；客户版风险提示卡+文案按需。触发："XX有没有雷""排查一下风险""这公司安全吗""红旗扫描"；命令 /caijing:risk。
---
