...
description: 财经·财报——只回答"这季财报行不行/财报前该看什么"。财报发布后的事件驱动快评：最新期核验 gate、同比环比速览、超预期三层基准判定（一致预期>公司指引>历史季节性）、扣非与现金流含金量验证、前瞻指标（合同负债/订单/资本开支）、对投资逻辑支柱的增强/削弱/中性影响；财报发布前可做 earnings preview（关键指标、三情景、催化清单）。产出专业版财报点评 docx + 客户版财报速览卡+文案。触发："XX出财报了""点评XX年报/中报/季报""这季业绩怎么样""财报前看什么""业绩预览"；命令 /caijing:earnings。
---
