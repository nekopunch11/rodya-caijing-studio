...
- 龙头复利（张坤/巴菲特式）——20 年后更强吗？看 ROIC 趋势
- 景气成长（赛道/成长）——一切顺利上限多大？看渗透率、营收增速
...
- **详实靠结构**：合格专业版是厚的、满版的（信息密集、图表穿插、少留白，走 docx-visual-spec 的"数据台密度"）；不每节强制分页造成半空页；大型公司完整基本面通常 15 页以上，短＝未完成。
- 深度地板七项全过（含一手证据最低量）；任一缺失列入"未完成项"。
