...
description: 财经内容台——给券商投顾/客户经理的财经内容生产工具包（A股+港股）。当用户要求分析个股/新股/题材并产出对客或自用内容时使用：全面分析某公司（基本面）、点评财报、判断估值贵不贵、排查财务风险/红旗、梳理题材产业链、体检A股/港股新股；产出专业版（研报级 docx）+ 客户版（卡片图+文案），多模块组合出汇报 PPT。触发词：基本面、财报点评、估值、贵不贵、排雷、红旗、产业链、受益标的、打新、新股体检、客户版、专业版、投顾内容。核心原则：只做客观数据体检、判断权交还客户、不荐股。
---
...
**只做客观数据体检、把判断权交还客户、不荐股。**客户版严禁买卖建议、目标价、操作指令、收益承诺。每次输出前必须对照 [references/compliance.md](references/compliance.md) 逐条检查。这是整套工具的合规护城河，破了这条整套就没意义。
